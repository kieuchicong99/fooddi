      ...
      <View style={{ height: screenHeight }}>
        ...
        <View style={{ flex: 4 }}>
          ...
          >
            ...
            <List renderHeader={'Phân phối món ăn'}>
              <Item disabled arrow="horizontal" thumb={<AntDesin name='swap' size={20} style={{ paddingRight: 10 }} />}
                onPress={() => {
                  navigate('Delivery')
                }}>
                Chuyển món ăn đã hoàn thành
              </Item>
            </List>


            <List renderHeader={'Đặt bàn'}>
              <Item disabled arrow="horizontal" thumb={<MaterialCommunity name='food' size={30} style={{ paddingRight: 10 }} />}
                onPress={() => {
                  navigate('OrderStackScreen')
                }}>
                Đặt bàn cho khách
              </Item>
            </List>
